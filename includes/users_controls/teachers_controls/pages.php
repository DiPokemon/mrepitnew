...
function school_teachers_render_form(string $mode, int $user_id = 0) {
    ...
    $tz    = $u ? (get_user_meta($user_id, 'teacher_timezone', true) ?: 'Europe/Tallinn') : 'Europe/Tallinn';
    ...
    echo '<tr><th><label>Телефон</label></th><td><input class="regular-text" name="teacher_phone" value="'.esc_attr($phone).'"></td></tr>';
